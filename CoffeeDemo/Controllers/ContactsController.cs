...
namespace CoffeeDemo.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ContactId,Firstname,Surname,ContactTypeId,Phone,TwitterHandle,GenderTypeId,IsActive")] Contact contact)
        {
